...
export default function Checkin() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Check-in</h1>
        <p className="text-sm text-gray-400 mt-0.5">Process book returns and renewals</p>
      </div>
