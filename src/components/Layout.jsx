...
import {
  ...
  PiCashRegister as FiCashRegister, PiListBullets as FiListBullets,
} from 'react-icons/pi';
...
const navItems = [
  ...
  { path: '/app/payment-history', icon: FiListBullets,  label: 'Payment History',      roles: ['LIBRARIAN', 'CIRCULATION_IN_CHARGE'] },
